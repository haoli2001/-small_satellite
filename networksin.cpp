...
Networksin::Networksin(CCycleBuffer *buffer1 ,QReadWriteLock *writelock, bool *isConnected, QString IP, quint16 PORT, QString SavePath, Gdata * pData, QObject *parent)
...
//    /***********回射信息*****************/
//    char buff[1024] ;
//    sprintf(buff,"FileHead recv");
//    ::send(mSocket,buff,sizeof(buff),0);
...
////        {
////            CASE_SID::fakeUi->setLinetext("通道 1 发送失败\n");
////            OnCloseSocket();
////            return;
////        }
////        else
////        {
////            CASE_SID::fakeUi->setLinetext("通道 1 请求发送完毕\n");
////            break;
////        }
    ...
    while(true)
    {
        ...
        while(true)
        {
            ...
            else
            {
                ...
                //CASE_SID::fakeUi->setLinetext(QString("解调器关闭, 通道 1 接收数据帧完毕, 共计 %1 Bytes\n").arg(RecAllLen + recSizes));
