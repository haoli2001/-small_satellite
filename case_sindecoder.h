#ifndef CASE_SINDECODER_H
#define CASE_SINDECODER_H
#include <QObject>
#include <QMutex>
#include <windows.h>
#include <QThread>
...
class CASE_SinDecoder : public QThread
{
    Q_OBJECT
public:
    explicit CASE_SinDecoder(bool *isRUNNING_DECODER, QObject *parent = nullptr);
...
private:
    ...
    QString mch1, mch2, mcompressed, savepath,mchsin;
